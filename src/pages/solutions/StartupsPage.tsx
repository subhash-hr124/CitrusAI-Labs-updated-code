...
import { Rocket, Zap, Target, BarChart3, ArrowRight } from 'lucide-react';
...
export const StartupsSolutionPage = ({ setCurrentPage }: SolutionPageProps) => {
  return (
    <div className="min-h-screen bg-deep-dark pt-32 pb-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center mb-32">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-display font-bold text-white mb-8 leading-[0.9] tracking-tighter lowercase">
              Scale Your Product at Light Speed
            </h1>
            <p className="text-xl text-[var(--text-body)] leading-relaxed mb-12 max-w-xl font-light">
              We partner with founders to build high-performance MVPs and prototype AI features that help you secure the next round of funding.
            </p>
          ...
          <div className="relative">
             <div className="aspect-square bg-[var(--dark-blue)] rounded-[4rem] border border-white/10 overflow-hidden relative group">
                ...
                <div className="p-12 h-full flex flex-col justify-center space-y-8">
                   {[
                     { title: "Rapid Prototyping", desc: "From wireframes to working AI models in weeks." },
                     { title: "Tech Strategy", icon: <Target />, desc: "Choose the right stack for long-term scalability." },
                     { title: "Growth Analytics", icon: <BarChart3 />, desc: "Track every interaction to find product-market fit." }
                   ].map((item, i) => (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
           {[
             { title: "Agile Development", icon: <Zap />, desc: "Iterative cycles that prioritize user feedback and fast deployments." },
             { title: "AI-Native Design", icon: <Rocket />, desc: "Thinking beyond prompts—designing entire agentic user experiences." },
             { title: "Cost-Efficient Cloud", icon: <Target />, desc: "Optimizing infrastructure to keep burn low while maximizing performance." }
           ].map((card, i) => (
